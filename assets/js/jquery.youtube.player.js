...
(function($, window, document, undefined){
	...
	player.prototype = {
		...
		removeVideo : function(video) {
			console.log(video);
			console.log(this.options.playlist.videos);
			for(i in this.options.playlist.videos) {
			    
			    if (this.options.playlist.videos[i]['id'] == video) {
			        this.options.playlist.videos.splice(i, 1);
			    }
			}
